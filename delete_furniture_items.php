...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_furniture_items1.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> DELETE YOUR FURNITUR ITEMS FROM HERE </h3>
...
$sql = "SELECT * FROM furniture f WHERE f.options = 'ENABLE' AND f.R_ID IN (SELECT r.R_ID FROM stores r WHERE r.M_ID='$user_check') ORDER BY F_ID";
