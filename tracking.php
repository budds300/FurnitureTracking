...
$user_check=$_SESSION['login_user2'];
  ...
  ?>
  <div class="jumbotron"><h1>Your order Status has not been updated</h1></div>
  <?php
}
...
<?php
  ...
  echo '<a  href="furniturelist.php"><button class="btn btn-warning" style="margin: 20px 0;"  >Continue Shopping</button></a>';
?>
</div>
