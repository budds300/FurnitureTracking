...
?>
<style>
   input[type=text], select,input[type=email],input[type=password],input[type=file],textarea,input[type=number] {
    width: 100%;
    padding: 12px 20px;
    margin: 8px 0;
    ...
    <div class="jumbotron">
     <strong>Want to contact <span class="edit"> Beta Furniture' </span>?</strong>
     <br>
