...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;">  FURNITURE ORDER TRACKING </h3>
...
$sql1 = "SELECT R_ID FROM stores WHERE M_ID='$user_check' ORDER BY R_ID";
...
<!-- <div class="col-xs-10"> -->
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> UPDATE FURNITURE ORDER STATUS </button>    
      </div>
        </form>
