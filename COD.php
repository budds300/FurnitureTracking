...
<h2 class="text-center"> Thank you for Ordering at Beta Furniture'! The ordering process is now complete.</h2>

<?php 
  $sql="SELECT order_ID FROM  orders WHERE username='$username' ORDER BY order_ID DESC ";
