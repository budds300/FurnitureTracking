...
input[type=submit]:hover {
  background-color: #45a049;
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> Beta Furniture' </span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"style="text-align:center;"> Create Account </div>
       ...
       <label style="margin-left: 5px;"><a href="managerlogin.php" style="color:blue">Have an account? Login.</a></label>
